...
async function updateInventoryTable() {
    try {
        const totalResponse = await fetch('/api/total-value');
...
async function initialLoad() {
    inventoryData = await (await fetch('/api/products')).json();
    transactionsData = await (await fetch('/api/transactions')).json();
    updateInventoryTable();
    updateTransactionTable();
}
